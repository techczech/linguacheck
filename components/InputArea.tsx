      ...
      <div className="p-4 bg-slate-50 border-b border-slate-200 flex flex-col gap-4">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-between items-start sm:items-center">
          <div className="flex items-center gap-3 w-full sm:w-auto">
            {/* Source Language */}
            <div className="flex flex-col gap-1 w-full sm:w-40 transition-all">
              ...
              {sourceSelectValue === 'custom' && (
                <input
                  ...
                  className="mt-1 block w-full rounded-md border-slate-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm py-1.5 px-3 bg-white border animate-fade-in"
                  disabled={isProcessing}
                  autoFocus
                />
              )}
          ...
          <div className="flex items-center gap-3 w-full sm:w-auto">
             <button
              ...
              className={`p-2 rounded-lg transition-colors border ${showSettings ? 'bg-indigo-50 border-indigo-200 text-indigo-600' : 'bg-white border-slate-200 text-slate-500 hover:bg-slate-50'}`}
            ...
            <button
              ...
              className={`
                px-6 py-2 rounded-lg font-medium text-sm transition-all duration-200 flex items-center gap-2 flex-1 sm:flex-initial justify-center
